...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst math_1 = __webpack_require__(/*! ./math */ \"./src/math.ts\");\nconst levels_1 = __webpack_require__(/*! ./levels/levels */ \"./src/levels/levels.ts\");\nlet state = {\n    player_position: { x: 0, y: 0 },\n    current_level: levels_1.levels[0],\n    movement: {\n        up: \"still\",\n        right: \"still\",\n    },\n};\nexports.merge_state = (s) => exports.set_state({ ...state, ...s });\nexports.set_state = (s) => (state = s);\nexports.get_state = () => state;\nexports.set_player_position = (pt) => Object.assign(state, { player_position: pt });\nexports.move_player = (pt) => exports.set_player_position(math_1.add_points(state.player_position, pt));\n\n\n//# sourceURL=webpack:///./src/state.ts?");
